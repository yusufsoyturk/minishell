...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/12 19:35:38 by ktoraman          #+#    #+#             */
/*   Updated: 2025/07/12 19:50:56 by ktoraman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	builtin_export(char **args, t_env **env, t_shell *mini)
{
	int		i;
	t_env	*node;
	...
	while (args[++i])
	{
		...
		else
		{
			...
			if (node)
				...
				append_env(env, create_env_node(ft_strdup(args[i]), NULL, 1));
		}
	}
	return (0);
}
